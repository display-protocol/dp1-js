...
- Leaf AJV helpers (`ValidateNote`, `ValidateEntity`, `ValidateDisplayPrefs`, `ValidateProvenanceBlock`, …) and fluent leaf builders (`NoteBuilder`, `EntityBuilder`, `DisplayPrefsBuilder`, …) exported from the package root.
