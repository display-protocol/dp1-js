        ...
        items: [
          {
            ...
            repro: {
              ...
              frameHash: {
                sha256:
                  "bf20f9a1b2c3d4e5f6789abcdef01234567890abcdef01234567890abcdef0123",
                phash: "0xaf39bc45",
              },
            },
            provenance: {
  ...
  describe("signPlaylist and verifyPlaylistSignature integration", () => {
    ...
    beforeEach(async () => {
      ...
      keyPair = {
        ...
        privateKey: hexToUint8Array(validPrivateKeyHex),
      };
    });

    describe("signDP1Playlist", () => {
      ...
      it("should create deterministic signatures for the same playlist", async () => {
        const signature1 = await signDP1Playlist(
          testPlaylist,
          keyPair.privateKey
        );
        const signature2 = await signDP1Playlist(
          testPlaylist,
          keyPair.privateKey
        );
      ...
      it("should create different signatures for different playlists", async () => {
        ...
        const signature2 = await signDP1Playlist(playlist2, keyPair.privateKey);
    ...
    describe("verifyPlaylistSignature", () => {
      it("should verify a valid signature", async () => {
        ...
        const isValid = await verifyPlaylistSignature(
          signedPlaylist,
          keyPair.publicKey
        );
